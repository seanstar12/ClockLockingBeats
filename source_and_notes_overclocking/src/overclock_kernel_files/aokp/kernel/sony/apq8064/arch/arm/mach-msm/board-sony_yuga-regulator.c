...
struct regulator_init_data msm8064_saw_regulator_pdata_8921_s5 =
	...
	SAW_VREG_INIT(S5, "8921_s5",  850000, 1350000);						//m0nk: upping from 1300000

struct regulator_init_data msm8064_saw_regulator_pdata_8921_s6 =
	/*	      	  ID  vreg_name	  min_uV  max_uV */
	SAW_VREG_INIT(S6, "8921_s6",  850000, 1350000);						//m0nk: upping from 1300000

struct regulator_init_data msm8064_saw_regulator_pdata_8821_s0 =
	/*	      	  ID  vreg_name	       min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",  850000, 1350000);				//m0nk: upping from 1300000

struct regulator_init_data msm8064_saw_regulator_pdata_8821_s1 =
	/*	      	  ID  vreg_name	       min_uV  max_uV */
	SAW_VREG_INIT(8821_S1, "8821_s1",  850000, 1350000);				//m0nk: upping from 1300000
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_SMPS(S3, 0, 1, 1,  500000, 1350000, NULL, 100000, 4p80, NONE, NONE),			//m0nk: upping from 1150000
	...
	RPM_LDO(L24, 0, 1, 1,  750000, 1250000, "8921_s1", 10000, 10000),					//m0nk: upping from 1150000
